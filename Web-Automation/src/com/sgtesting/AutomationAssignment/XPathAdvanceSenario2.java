...
public class XPathAdvanceSenario2 {
	...
	static void ModifyUsers() {
		try {
			...
			oBrowser.findElement(By.xpath("//a[@class='content users']")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//span[text()='Test, User1'][@class='userNameSpan']")).click();
			Thread.sleep(2000);
			...
			oBrowser.findElement(By.xpath("//span[text()='Test, User2'][@class='userNameSpan']")).click();
			Thread.sleep(2000);
			...
			oBrowser.findElement(By.xpath("//span[text()='Test, User3'][@class='userNameSpan']")).click();
			Thread.sleep(2000);
